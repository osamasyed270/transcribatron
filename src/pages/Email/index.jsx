...
import {
  setFolders,
} from "@/redux-toolkit/reducers/Email";

// layouts
import NavBar from "../../Layouts/NavBar";
// import FMTreeSideBar from "../../Layouts/FMTreeSideBar";
import EmailService from "@/services/email";
import EmailTreeSideBar from "./EmailTreeSideBar";
import EmailMiddlePanel  from "./EmailMiddlePanel";
...
const MainLyt = () => {
  ...
  useEffect(() => {
    if (window) {
      if (window.innerWidth <= 800) {
        ...
        dispatch(setRightSidebarWidth((window.innerWidth - 250) / 2 ));
      }
    }
  ...
  const rightSidebarMouseDown = () => {
    ...
    const mpArgs = {currentEmail, setCurrentEmail, currentFolder};
    const rpArgs = {currentEmail};
    const lpArgs = {currentFolder, setCurrentFolder};
  return (
      ...
      <div className="flex z-20 bg-white justify-between w-full h-[60px] items-center border-b-[#dee0e4] border-b-[1px] top-[82px] fixed">
        ...
        >
          <a href="#" className="text-[16px] text-[#757575] font-medium">
            <span>Deskvantage Cloud Mail</span>
          </a>
        </Breadcrumbs>
      </div>
      <div className="mt-[142px] flex h-full relative">
        <div
          ...
          style={{
            ...
            display: `${(showLeftSideBar || showLeftBarOnMobile) === true ? "flex" : "hidden"
            }`,
       ...
       <div className="flex h-full relative">
        <div
          ...
          style={{
            ...
            display: `${(showRightSideBar || showRightBarOnMobile) === true ? "flex" : "hidden"
            }`,
